...
const Promo: FC<PromoProps> = ({ image, title, description, buttonText }) => {
  return (
    <section className="h-[20vh]">
      <div className="relative mx-auto -mt-[75px] w-[calc(100%-48px)] rounded-[10px] lg:-mt-[100px]">
        <NextImage
        ...
        <div className="relative flex h-fit w-full flex-col items-center rounded-[10px] bg-red bg-opacity-90 px-[51px] py-[18px] lg:py-[50px]">
          ...
          <button className="mt-4 w-fit rounded-2xl bg-orange px-[12px] py-[8px] font-worksans text-[12px] font-semibold uppercase leading-[1.3] text-white lg:px-[16px] lg:text-sm">
            {buttonText}
          </button>
        </div>
      </div>
